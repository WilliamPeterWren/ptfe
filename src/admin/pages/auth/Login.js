...
function Login() {
  ...
  const handleChangeFormLogin = (e) => {
    ...
    setFormLogin((prev) => ({
      ...
      [name]: value, // Update the specific property using the input's name
    }));
    setError(""); 
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <div className="flex items-center justify-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-700">dashlite</h1>
        </div>
        <h2 className="text-3xl font-semibold text-gray-800 text-center mb-2">
          Seller Login
        </h2>
        <p className="text-gray-600 text-center mb-6">
          Access the PETER panel using your email and passcode.
        </p>
        {error && (
          <div
